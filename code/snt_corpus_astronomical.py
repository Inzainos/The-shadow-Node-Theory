...
def ajustar_ley_potencia(años, sombra, dominante, trigger_año):
    ...
    try:
        ...
        if b > 2.0:    clf = "Satelizacion extrema (b>2)"
        elif b > 1.0:  clf = "Satelizacion rapida sin friccion"
        elif b > 0.3:  clf = "Satelizacion activa"
        elif b > 0.05: clf = "Satelizacion gradual"
        elif b > -0.1: clf = "Estado estacionario / equilibrio"
        else:          clf = "Convergencia / leapfrog"
        result.update({"a": round(a, 6), "b": round(b, 4),
